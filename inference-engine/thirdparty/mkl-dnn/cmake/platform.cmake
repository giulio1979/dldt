...
elseif(UNIX OR MINGW)
    append(CMAKE_CCXX_FLAGS " ")
    append_if_product(CMAKE_CCXX_FLAGS "-Wno-error")
...
append(CMAKE_CCXX_NOWARN_FLAGS "-Wno-error")
append(CMAKE_CCXX_NOWARN_FLAGS "-Wno-strict-overflow -Wno-stringop-overflow=")
if(UNIX OR MINGW)
    if(CMAKE_CXX_COMPILER_ID STREQUAL "Intel")
